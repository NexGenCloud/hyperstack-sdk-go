...
// checks if the FlavorResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlavorResponse{}

// FlavorResponse struct for FlavorResponse
...
func (o FlavorResponse) MarshalJSON() ([]byte, error) {
...
func (o FlavorResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFlavorResponse struct {
	value *FlavorResponse
	isSet bool
}

func (v NullableFlavorResponse) Get() *FlavorResponse {
	return v.value
}

func (v *NullableFlavorResponse) Set(val *FlavorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFlavorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFlavorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlavorResponse(val *FlavorResponse) *NullableFlavorResponse {
	return &NullableFlavorResponse{value: val, isSet: true}
}

func (v NullableFlavorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlavorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
