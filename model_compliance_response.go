...
// checks if the ComplianceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComplianceResponse{}

// ComplianceResponse struct for ComplianceResponse
...
// SetCompliance gets a reference to the given ComplianceFields and assigns it to the Compliance field.
...
func (o ComplianceResponse) MarshalJSON() ([]byte, error) {
...
func (o ComplianceResponse) ToMap() (map[string]interface{}, error) {
...
type NullableComplianceResponse struct {
	value *ComplianceResponse
	isSet bool
}

func (v NullableComplianceResponse) Get() *ComplianceResponse {
	return v.value
}

func (v *NullableComplianceResponse) Set(val *ComplianceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableComplianceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableComplianceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComplianceResponse(val *ComplianceResponse) *NullableComplianceResponse {
	return &NullableComplianceResponse{value: val, isSet: true}
}

func (v NullableComplianceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComplianceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
