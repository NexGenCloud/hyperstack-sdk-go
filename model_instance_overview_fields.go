...
// checks if the InstanceOverviewFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceOverviewFields{}

// InstanceOverviewFields struct for InstanceOverviewFields
...
func (o InstanceOverviewFields) MarshalJSON() ([]byte, error) {
...
func (o InstanceOverviewFields) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceOverviewFields struct {
	value *InstanceOverviewFields
	isSet bool
}

func (v NullableInstanceOverviewFields) Get() *InstanceOverviewFields {
	return v.value
}

func (v *NullableInstanceOverviewFields) Set(val *InstanceOverviewFields) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceOverviewFields) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceOverviewFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceOverviewFields(val *InstanceOverviewFields) *NullableInstanceOverviewFields {
	return &NullableInstanceOverviewFields{value: val, isSet: true}
}

func (v NullableInstanceOverviewFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceOverviewFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
