...
// checks if the BillingHistoryFineTuning type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingHistoryFineTuning{}

// BillingHistoryFineTuning struct for BillingHistoryFineTuning
...
func (o BillingHistoryFineTuning) MarshalJSON() ([]byte, error) {
...
func (o BillingHistoryFineTuning) ToMap() (map[string]interface{}, error) {
...
type NullableBillingHistoryFineTuning struct {
	value *BillingHistoryFineTuning
	isSet bool
}

func (v NullableBillingHistoryFineTuning) Get() *BillingHistoryFineTuning {
	return v.value
}

func (v *NullableBillingHistoryFineTuning) Set(val *BillingHistoryFineTuning) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingHistoryFineTuning) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingHistoryFineTuning) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingHistoryFineTuning(val *BillingHistoryFineTuning) *NullableBillingHistoryFineTuning {
	return &NullableBillingHistoryFineTuning{value: val, isSet: true}
}

func (v NullableBillingHistoryFineTuning) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingHistoryFineTuning) UnmarshalJSON(src []byte) error {
	v.isSet = true
