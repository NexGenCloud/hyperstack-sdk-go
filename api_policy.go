...
func (r ApiListPoliciesRequest) Execute() (*GetPoliciesResponseModel, *http.Response, error) {
...
func (a *PolicyAPIService) ListPoliciesExecute(r ApiListPoliciesRequest) (*GetPoliciesResponseModel, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetPoliciesResponseModel
	)
