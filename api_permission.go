...
func (r ApiListPermissionsRequest) Execute() (*GetPermissionsResponseModel, *http.Response, error) {
...
func (a *PermissionAPIService) ListPermissionsExecute(r ApiListPermissionsRequest) (*GetPermissionsResponseModel, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *GetPermissionsResponseModel
	)
