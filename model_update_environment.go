...
// UpdateEnvironment struct for UpdateEnvironment
type UpdateEnvironment struct {
	// The new name of the environment.
	Name string `json:"name"`
}

type _UpdateEnvironment UpdateEnvironment
...
func (o *UpdateEnvironment) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateEnvironment := _UpdateEnvironment{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateEnvironment)

	if err != nil {
		return err
	}

	*o = UpdateEnvironment(varUpdateEnvironment)
