...
------------ | ------------- | ------------- | -------------
*AccessKeysAPI* | [**CreateAccessKeyEndpoint**](docs/AccessKeysAPI.md#createaccesskeyendpoint) | **Post** /object-storage/access-keys | Generate a new access key
*AccessKeysAPI* | [**DeleteAccessKeyEndpoint**](docs/AccessKeysAPI.md#deleteaccesskeyendpoint) | **Delete** /object-storage/access-keys/{access_key_id} | Remove an existing access key
*AccessKeysAPI* | [**ListAccessKeysEndpoint**](docs/AccessKeysAPI.md#listaccesskeysendpoint) | **Get** /object-storage/access-keys | List access keys
...
*AuthAPI* | [**DisableMFA**](docs/AuthAPI.md#disablemfa) | **Post** /auth/me/mfa/disable | 
...
*AutoTopupAPI* | [**CreateAutoTopUp**](docs/AutoTopupAPI.md#createautotopup) | **Post** /billing/auto-topup | Create an auto top up configuration and initiate Stripe setup
*AutoTopupAPI* | [**DisableAutoTopUp**](docs/AutoTopupAPI.md#disableautotopup) | **Delete** /billing/auto-topup | Disable auto top up, preventing any future automatic charges
*AutoTopupAPI* | [**GetAutoTopUp**](docs/AutoTopupAPI.md#getautotopup) | **Get** /billing/auto-topup | Retrieve the current auto top up configuration and transaction history
*AutoTopupAPI* | [**GetAutoTopUpStatus**](docs/AutoTopupAPI.md#getautotopupstatus) | **Get** /billing/auto-topup/status | Get auto top-up status and configuration
*AutoTopupAPI* | [**UpdateAutoTopUp**](docs/AutoTopupAPI.md#updateautotopup) | **Put** /billing/auto-topup | Update an existing active auto top up configuration
...
*BillingAPI* | [**GetImageGenerationBillingHistory**](docs/BillingAPI.md#getimagegenerationbillinghistory) | **Get** /billing/billing/history/image_generation | Retrieve Billing History of image generation for a specific Billing Cycle
*BillingAPI* | [**GetImageGenerationBillingHistoryGraph**](docs/BillingAPI.md#getimagegenerationbillinghistorygraph) | **Get** /billing/billing/history/image_generation/{resource_id}/graph | Retrieve hourly cost datapoints of a Specific Image Generation for a specific
*BillingAPI* | [**GetImageGenerationHistoryForResource**](docs/BillingAPI.md#getimagegenerationhistoryforresource) | **Get** /billing/billing/history/image_generation/{resource_id} | 
...
*EmailOptInOutAPI* | [**GetEmailPreferencesForAUser**](docs/EmailOptInOutAPI.md#getemailpreferencesforauser) | **Get** /auth/email/opt-out | Get all email preferences for the authenticated user
*EmailOptInOutAPI* | [**ToggleAllOptionalEmailPreferencesForTheUser**](docs/EmailOptInOutAPI.md#togglealloptionalemailpreferencesfortheuser) | **Put** /auth/email/opt-out | Toggle all optional email preferences for the authenticated user
*EmailOptInOutAPI* | [**UpdateEmailPreferenceForACategoryBySlug**](docs/EmailOptInOutAPI.md#updateemailpreferenceforacategorybyslug) | **Put** /auth/email/opt-out/{slug} | Update email preference opted_in status for a category slug
...
*EnvironmentAPI* | [**GetEnvironmentVMQuota**](docs/EnvironmentAPI.md#getenvironmentvmquota) | **Get** /core/environments/{id}/vm-quota | Get environment VM quota
...
*HealthAPI* | [**HealthzEndpoint**](docs/HealthAPI.md#healthzendpoint) | **Get** /object-storage/healthz | Healthcheck
...
*KeypairAPI* | [**ListSupportedKeyPairTypes**](docs/KeypairAPI.md#listsupportedkeypairtypes) | **Get** /core/supported-keypairs | List supported key pair types
...
*RegionsAPI* | [**ListRegionsEndpoint**](docs/RegionsAPI.md#listregionsendpoint) | **Get** /object-storage/regions | Get a list of supported regions
...
*UserAPI* | [**GetAllowedCountryCodes**](docs/UserAPI.md#getallowedcountrycodes) | **Get** /billing/user/countries | GET: Retrieve allowed country codes
...
*UserConsentAPI* | [**AddANewConsentForAUser**](docs/UserConsentAPI.md#addanewconsentforauser) | **Post** /auth/user-consent | Add a new User consent
*UserConsentAPI* | [**GetAllConsentTemplates**](docs/UserConsentAPI.md#getallconsenttemplates) | **Get** /auth/user-consent/templates | Get all consent templates
*UserConsentAPI* | [**GetAllConsentsForAUser**](docs/UserConsentAPI.md#getallconsentsforauser) | **Get** /auth/user-consent | Get Consents for a User
*UserConsentAPI* | [**GetConsentTemplateByType**](docs/UserConsentAPI.md#getconsenttemplatebytype) | **Get** /auth/user-consent/templates/{consent_type} | Get consent template for a specific type
*UserConsentAPI* | [**UpdateAConsentActionByType**](docs/UserConsentAPI.md#updateaconsentactionbytype) | **Patch** /auth/user-consent/{consent_type} | Grant or revoke an existing consent
*UserConsentEventsAPI* | [**GetConsentAuditEvents**](docs/UserConsentEventsAPI.md#getconsentauditevents) | **Get** /auth/user-consent-events/{consent_type}/events | Get audit trail for a consent
...
*VirtualMachineAPI* | [**ToggleEnhancedMetricsForAVM**](docs/VirtualMachineAPI.md#toggleenhancedmetricsforavm) | **Patch** /core/virtual-machines/{vm_id}/enhanced-metrics | Enable or disable Enhanced Metrics for a virtual machine
...
## Documentation For Models
 ...
 - [AllowedCountriesResponse](docs/AllowedCountriesResponse.md)
 ...
 - [AutoTopup](docs/AutoTopup.md)
 - [AutoTopupErrorResponse](docs/AutoTopupErrorResponse.md)
 - [AutoTopupStatusSchema](docs/AutoTopupStatusSchema.md)
 ...
 - [BillingHistoryImageGenerationDetails](docs/BillingHistoryImageGenerationDetails.md)
 ...
 - [ConsentActionResponse](docs/ConsentActionResponse.md)
 - [ConsentBlock](docs/ConsentBlock.md)
 - [ConsentEventsResponse](docs/ConsentEventsResponse.md)
 - [ConsentTemplate](docs/ConsentTemplate.md)
 - [ConsentTemplatesResponse](docs/ConsentTemplatesResponse.md)
 ...
 - [CreateAutoTopupPayload](docs/CreateAutoTopupPayload.md)
 - [CreateAutoTopupResponse](docs/CreateAutoTopupResponse.md)
 ...
 - [DisableAutoTopupResponse](docs/DisableAutoTopupResponse.md)
 - [EditLabelOfAnExistingVMPayload](docs/EditLabelOfAnExistingVMPayload.md)
 - [EmailCategory](docs/EmailCategory.md)
 - [EmailCategoryChild](docs/EmailCategoryChild.md)
 - [EmailPreferencesResponse](docs/EmailPreferencesResponse.md)
 ...
 - [GetAutoTopupResponse](docs/GetAutoTopupResponse.md)
 ...
 - [SupportedKeypairPublicKeyTypesResponse](docs/SupportedKeypairPublicKeyTypesResponse.md)
 - [Template](docs/Template.md)
 - [TemplateFields](docs/TemplateFields.md)
 - [Templates](docs/Templates.md)
 - [TokenBasedBillingHistoryResponse](docs/TokenBasedBillingHistoryResponse.md)
 - [URIs](docs/URIs.md)
 - [UpdateAutoTopupPayload](docs/UpdateAutoTopupPayload.md)
 - [UpdateAutoTopupResponse](docs/UpdateAutoTopupResponse.md)
 - [UpdateClusterNodeGroupPayload](docs/UpdateClusterNodeGroupPayload.md)
 - [UpdateConsentRequest](docs/UpdateConsentRequest.md)
 - [UpdateEmailPreferenceInput](docs/UpdateEmailPreferenceInput.md)
 - [UpdateEmailPreferenceResponse](docs/UpdateEmailPreferenceResponse.md)
 ...
 - [UserConsentEvent](docs/UserConsentEvent.md)
