// Package security_rules provides primitives to interact with the openapi HTTP API.
//
...
// SecurityRulesProtocolFields defines model for Security_Rules_Protocol_Fields.
...
func NewListFirewallRuleProtocolsRequest(server string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/core/sg-rules-protocols")
	if operationPath[0] == '/' {
...
func ParseListFirewallRuleProtocolsResponse(rsp *http.Response) (*ListFirewallRuleProtocolsResponse, error) {
	...
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest SecurityRulesProtocolFields
