...
type ClientInterface interface {
	...
	AddFirewallRuleToVirtualMachineWithBody(ctx context.Context, vmId int, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	AddFirewallRuleToVirtualMachine(ctx context.Context, vmId int, body AddFirewallRuleToVirtualMachineJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DeleteFirewallRuleFromVirtualMachine request
	DeleteFirewallRuleFromVirtualMachine(ctx context.Context, vmId int, sgRuleId int, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) AddFirewallRuleToVirtualMachineWithBody(ctx context.Context, vmId int, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAddFirewallRuleToVirtualMachineRequestWithBody(c.Server, vmId, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) AddFirewallRuleToVirtualMachine(ctx context.Context, vmId int, body AddFirewallRuleToVirtualMachineJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAddFirewallRuleToVirtualMachineRequest(c.Server, vmId, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeleteFirewallRuleFromVirtualMachine(ctx context.Context, vmId int, sgRuleId int, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteFirewallRuleFromVirtualMachineRequest(c.Server, vmId, sgRuleId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewAddFirewallRuleToVirtualMachineRequest(server string, vmId int, body AddFirewallRuleToVirtualMachineJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewAddFirewallRuleToVirtualMachineRequestWithBody(server, vmId, "application/json", bodyReader)
}
...
func NewAddFirewallRuleToVirtualMachineRequestWithBody(server string, vmId int, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func NewDeleteFirewallRuleFromVirtualMachineRequest(server string, vmId int, sgRuleId int) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	AddFirewallRuleToVirtualMachineWithBodyWithResponse(ctx context.Context, vmId int, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AddFirewallRuleToVirtualMachineResponse, error)

	AddFirewallRuleToVirtualMachineWithResponse(ctx context.Context, vmId int, body AddFirewallRuleToVirtualMachineJSONRequestBody, reqEditors ...RequestEditorFn) (*AddFirewallRuleToVirtualMachineResponse, error)

	// DeleteFirewallRuleFromVirtualMachineWithResponse request
	DeleteFirewallRuleFromVirtualMachineWithResponse(ctx context.Context, vmId int, sgRuleId int, reqEditors ...RequestEditorFn) (*DeleteFirewallRuleFromVirtualMachineResponse, error)
...
func (c *ClientWithResponses) AddFirewallRuleToVirtualMachineWithBodyWithResponse(ctx context.Context, vmId int, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AddFirewallRuleToVirtualMachineResponse, error) {
	rsp, err := c.AddFirewallRuleToVirtualMachineWithBody(ctx, vmId, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) AddFirewallRuleToVirtualMachineWithResponse(ctx context.Context, vmId int, body AddFirewallRuleToVirtualMachineJSONRequestBody, reqEditors ...RequestEditorFn) (*AddFirewallRuleToVirtualMachineResponse, error) {
	rsp, err := c.AddFirewallRuleToVirtualMachine(ctx, vmId, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAddFirewallRuleToVirtualMachineResponse(rsp)
...
func (c *ClientWithResponses) DeleteFirewallRuleFromVirtualMachineWithResponse(ctx context.Context, vmId int, sgRuleId int, reqEditors ...RequestEditorFn) (*DeleteFirewallRuleFromVirtualMachineResponse, error) {
	rsp, err := c.DeleteFirewallRuleFromVirtualMachine(ctx, vmId, sgRuleId, reqEditors...)
	if err != nil {
		return nil, err
	}
