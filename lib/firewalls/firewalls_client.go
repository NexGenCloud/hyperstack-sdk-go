...
// CreateFirewallRulePayload defines model for Create Firewall Rule Payload.
...
// FirewallAttachmentModel defines model for Firewall Attachment Model.
...
// FirewallAttachmentVMModel defines model for Firewall Attachment VM Model.
...
// FirewallRule defines model for Firewall Rule.
...
type ClientInterface interface {
	...
	RetrieveFirewalls(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) RetrieveFirewalls(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewRetrieveFirewallsRequest(c.Server)
	if err != nil {
		return nil, err
	}
...
func NewRetrieveFirewallsRequest(server string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	RetrieveFirewallsWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*RetrieveFirewallsResponse, error)
...
func (c *ClientWithResponses) RetrieveFirewallsWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*RetrieveFirewallsResponse, error) {
	rsp, err := c.RetrieveFirewalls(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
