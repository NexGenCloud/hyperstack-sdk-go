...
// checks if the ResourceLevelGraphBillingDetailsAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceLevelGraphBillingDetailsAttributes{}

// ResourceLevelGraphBillingDetailsAttributes struct for ResourceLevelGraphBillingDetailsAttributes
...
func NewResourceLevelGraphBillingDetailsAttributes() *ResourceLevelGraphBillingDetailsAttributes {
	this := ResourceLevelGraphBillingDetailsAttributes{}
	return &this
}
...
func (o ResourceLevelGraphBillingDetailsAttributes) MarshalJSON() ([]byte, error) {
...
func (o ResourceLevelGraphBillingDetailsAttributes) ToMap() (map[string]interface{}, error) {
...
type NullableResourceLevelGraphBillingDetailsAttributes struct {
	value *ResourceLevelGraphBillingDetailsAttributes
	isSet bool
}

func (v NullableResourceLevelGraphBillingDetailsAttributes) Get() *ResourceLevelGraphBillingDetailsAttributes {
	return v.value
}

func (v *NullableResourceLevelGraphBillingDetailsAttributes) Set(val *ResourceLevelGraphBillingDetailsAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceLevelGraphBillingDetailsAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceLevelGraphBillingDetailsAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceLevelGraphBillingDetailsAttributes(val *ResourceLevelGraphBillingDetailsAttributes) *NullableResourceLevelGraphBillingDetailsAttributes {
	return &NullableResourceLevelGraphBillingDetailsAttributes{value: val, isSet: true}
}

func (v NullableResourceLevelGraphBillingDetailsAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceLevelGraphBillingDetailsAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
