...
type ApiGetAllowedCountryCodesRequest struct {
	ctx        context.Context
	ApiService *UserAPIService
}

func (r ApiGetAllowedCountryCodesRequest) Execute() (*AllowedCountriesResponse, *http.Response, error) {
	return r.ApiService.GetAllowedCountryCodesExecute(r)
}

/*
GetAllowedCountryCodes GET: Retrieve allowed country codes

Retrieve the list of allowed ISO 3166-1 alpha-2 country codes that can be used for billing information.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetAllowedCountryCodesRequest
*/
func (a *UserAPIService) GetAllowedCountryCodes(ctx context.Context) ApiGetAllowedCountryCodesRequest {
	return ApiGetAllowedCountryCodesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *UserAPIService) GetAllowedCountryCodesExecute(r ApiGetAllowedCountryCodesRequest) (*AllowedCountriesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AllowedCountriesResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserAPIService.GetAllowedCountryCodes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/billing/user/countries"
