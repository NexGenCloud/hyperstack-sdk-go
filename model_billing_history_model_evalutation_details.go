...
// checks if the BillingHistoryModelEvalutationDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingHistoryModelEvalutationDetails{}

// BillingHistoryModelEvalutationDetails struct for BillingHistoryModelEvalutationDetails
...
func NewBillingHistoryModelEvalutationDetails() *BillingHistoryModelEvalutationDetails {
	this := BillingHistoryModelEvalutationDetails{}
	return &this
}
...
func (o BillingHistoryModelEvalutationDetails) MarshalJSON() ([]byte, error) {
...
func (o BillingHistoryModelEvalutationDetails) ToMap() (map[string]interface{}, error) {
...
type NullableBillingHistoryModelEvalutationDetails struct {
	value *BillingHistoryModelEvalutationDetails
	isSet bool
}

func (v NullableBillingHistoryModelEvalutationDetails) Get() *BillingHistoryModelEvalutationDetails {
	return v.value
}

func (v *NullableBillingHistoryModelEvalutationDetails) Set(val *BillingHistoryModelEvalutationDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingHistoryModelEvalutationDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingHistoryModelEvalutationDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingHistoryModelEvalutationDetails(val *BillingHistoryModelEvalutationDetails) *NullableBillingHistoryModelEvalutationDetails {
	return &NullableBillingHistoryModelEvalutationDetails{value: val, isSet: true}
}

func (v NullableBillingHistoryModelEvalutationDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingHistoryModelEvalutationDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
