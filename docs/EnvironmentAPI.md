...
> Environment GetEnvironment(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.EnvironmentAPI.GetEnvironment(context.Background(), id).Execute()
	if err != nil {
...
> VMQuota GetEnvironmentVMQuota(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.EnvironmentAPI.GetEnvironmentVMQuota(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `EnvironmentAPI.GetEnvironmentVMQuota``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetEnvironmentVMQuota`: VMQuota
	fmt.Fprintf(os.Stdout, "Response from `EnvironmentAPI.GetEnvironmentVMQuota`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetEnvironmentVMQuotaRequest struct via the builder pattern
