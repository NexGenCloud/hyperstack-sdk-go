...
func main() {
	payload := *openapiclient.NewCreateClusterPayload("EnvironmentName_example", "ImageName_example", "KeypairName_example", "KubernetesVersion_example", "MasterFlavorName_example", "Name_example") // CreateClusterPayload | 
