...
/*
GetVolume Fetch Volume Details
...
*/
func (a *VolumeAPIService) GetVolume(ctx context.Context, volumeId int32) ApiGetVolumeRequest {
	return ApiGetVolumeRequest{
		ApiService: a,
		ctx:        ctx,
		volumeId:   volumeId,
...
//
//	@return Volume
func (a *VolumeAPIService) GetVolumeExecute(r ApiGetVolumeRequest) (*Volume, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
