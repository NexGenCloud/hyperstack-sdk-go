...
type ApiListSupportedKeyPairTypesRequest struct {
	ctx        context.Context
	ApiService *KeypairAPIService
}

func (r ApiListSupportedKeyPairTypesRequest) Execute() (*SupportedKeypairPublicKeyTypesResponse, *http.Response, error) {
	return r.ApiService.ListSupportedKeyPairTypesExecute(r)
}

/*
ListSupportedKeyPairTypes List supported key pair types

Retrieves the SSH public key types supported for import.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiListSupportedKeyPairTypesRequest
*/
func (a *KeypairAPIService) ListSupportedKeyPairTypes(ctx context.Context) ApiListSupportedKeyPairTypesRequest {
	return ApiListSupportedKeyPairTypesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return SupportedKeypairPublicKeyTypesResponse
func (a *KeypairAPIService) ListSupportedKeyPairTypesExecute(r ApiListSupportedKeyPairTypesRequest) (*SupportedKeypairPublicKeyTypesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SupportedKeypairPublicKeyTypesResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KeypairAPIService.ListSupportedKeyPairTypes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/core/supported-keypairs"
