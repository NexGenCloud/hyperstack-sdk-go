...
*/
func (a *VolumeAttachmentAPIService) AttachVolumesToVirtualMachine(ctx context.Context, virtualMachineId int32) ApiAttachVolumesToVirtualMachineRequest {
	return ApiAttachVolumesToVirtualMachineRequest{
		ApiService:       a,
		ctx:              ctx,
...
func (a *VolumeAttachmentAPIService) AttachVolumesToVirtualMachineExecute(r ApiAttachVolumesToVirtualMachineRequest) (*AttachVolumes, *http.Response, error) {
	...
	localVarPath := localBasePath + "/core/virtual-machines/{virtual_machine_id}/attach-volumes"
...
*/
func (a *VolumeAttachmentAPIService) DetachVolumesFromVirtualMachine(ctx context.Context, virtualMachineId int32) ApiDetachVolumesFromVirtualMachineRequest {
	return ApiDetachVolumesFromVirtualMachineRequest{
		ApiService:       a,
		ctx:              ctx,
		virtualMachineId: virtualMachineId,
...
func (a *VolumeAttachmentAPIService) DetachVolumesFromVirtualMachineExecute(r ApiDetachVolumesFromVirtualMachineRequest) (*DetachVolumes, *http.Response, error) {
	...
	localVarPath := localBasePath + "/core/virtual-machines/{virtual_machine_id}/detach-volumes"
	localVarPath = strings.Replace(localVarPath, "{"+"virtual_machine_id"+"}", url.PathEscape(parameterValueToString(r.virtualMachineId, "virtualMachineId")), -1)
