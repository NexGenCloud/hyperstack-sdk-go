...
func Test_hyperstack_TemplateAPIService(t *testing.T) {
	...
	t.Run("Test TemplateAPIService DeleteTemplate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.TemplateAPI.DeleteTemplate(context.Background(), id).Execute()
	...
	t.Run("Test TemplateAPIService UpdateTemplate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.TemplateAPI.UpdateTemplate(context.Background(), id).Execute()
